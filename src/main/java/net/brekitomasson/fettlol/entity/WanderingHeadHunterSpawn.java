...
public class WanderingHeadHunterSpawn {
    ...
    private static void spawnTrader(ServerWorld serverWorld) {
        ...
        if (playerEntity != null) {
            ...
            Optional<BlockPos> optional = poiStorage.getPosition(PointOfInterestType.MEETING.getCompletionCondition(), (blockposX) -> true, blockPos, 48, PointOfInterestStorage.OccupationStatus.ANY);
            ...
            if (blockPos3 != null && wontSuffocateAt(serverWorld, blockPos3)) {
                WanderingHeadHunterEntity traderEntity = Entities.WANDERING_HEAD_HUNTER.spawn(serverWorld, (CompoundTag) null, (Text) null, (PlayerEntity) null, blockPos3, SpawnReason.EVENT, false, false);
