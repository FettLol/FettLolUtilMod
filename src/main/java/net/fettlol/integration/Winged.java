...
public class Winged {
        ...
        if (ModIntegrations.isWingedLoaded) {
            ...
            LootTableLoadingCallback.EVENT.register((resourceManager, lootManager, identifier, supplier, setter) -> {
                ...
                if (LootTableHelper.isEndEndgame(identifier)) {
                    LootTableHelper.addToLootTable(supplier, 1, 0.01F, Integrations.WINGED, "wing_random");
                }
            });
        }
    }
    ...
    public static void removeRecipes() {
        RecipeHelper.removeRecipe(Integrations.WINGED, "booster_empty_left");
        RecipeHelper.removeRecipe(Integrations.WINGED, "booster_empty_right");
        RecipeHelper.removeRecipe(Integrations.WINGED, "booster_fast");
        RecipeHelper.removeRecipe(Integrations.WINGED, "booster_slow");
        RecipeHelper.removeRecipe(Integrations.WINGED, "booster_standard");
        RecipeHelper.removeRecipe(Integrations.WINGED, "forward_launcher");
        RecipeHelper.removeRecipe(Integrations.WINGED, "fuel_pellet_fast");
        RecipeHelper.removeRecipe(Integrations.WINGED, "fuel_pellet_slow");
        RecipeHelper.removeRecipe(Integrations.WINGED, "fuel_pellet_standard");
        RecipeHelper.removeRecipe(Integrations.WINGED, "glue_broken_heart_of_the_sky");
        RecipeHelper.removeRecipe(Integrations.WINGED, "heart_of_the_sky");
        RecipeHelper.removeRecipe(Integrations.WINGED, "speedometer");
    }
    ...
    private static void replaceCoreOfFlightRecipe() {
        ...
        RecipeHelper.removeRecipe(Integrations.WINGED, "glue_broken_core_of_flight");
        ...
        FettlolRecipes.CUSTOM_RECIPES.put(
            ...
            RecipeHelper.createShapedRecipe(
                ...
                Lists.newArrayList(
                    ...
                    new Identifier(Integrations.WINGED, "broken_core_of_flight"),
                ...
                new Identifier(Integrations.WINGED, "core_of_flight")
            )
        );
    }
}
