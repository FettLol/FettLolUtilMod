...
public class FettlolLootTables {
    ...
    public static void init() {
        LootTableLoadingCallback.EVENT.register((resourceManager, lootManager, identifier, supplier, setter) -> {
            ...
            // Add Jade Gem to Evokers (20%)
            if (LootTableHelper.isEvoker(identifier)) {
                LootTableHelper.addToLootTable(supplier, 1, 0.2F, "fettlol:jade_gem");
            }
            ...
            if (LootTableHelper.isLapisOre(identifier)) {
                LootTableHelper.addToOreLootTable(supplier, 1, 0.02F, "fettlol:aquamarine_gem");
            }
            ...
            // Wither skeletons can drop Wither bones (3 separate 10% rolls)
            if (LootTableHelper.isWitherSkeleton(identifier)) {
                LootTableHelper.addToLootTable(supplier, 3, 0.1F, "fettlol:wither_bone");
            }
