...
public class LootTableHelper {
    ...
    public static final List<String> CAT_MORNING_GIFT;
    public static final List<String> FISHING_JUNK;
    public static final List<String> FISHING_TREASURES;
    public static final List<String> PIGLIN_BARTERING;
    public static final List<String> VILLAGER_HERO_ARMORER_GIFT;
    public static final List<String> VILLAGER_HERO_BUTCHER_GIFT;
    public static final List<String> VILLAGER_HERO_CARTOGRAPHER_GIFT;
    public static final List<String> VILLAGER_HERO_CLERIC_GIFT;
    public static final List<String> VILLAGER_HERO_FARMER_GIFT;
    public static final List<String> VILLAGER_HERO_FISHERMAN_GIFT;
    public static final List<String> VILLAGER_HERO_FLETCHER_GIFT;
    public static final List<String> VILLAGER_HERO_LEATHERWORKER_GIFT;
    public static final List<String> VILLAGER_HERO_LIBRARIAN_GIFT;
    public static final List<String> VILLAGER_HERO_MASON_GIFT;
    public static final List<String> VILLAGER_HERO_SHEPHERD_GIFT;
    public static final List<String> VILLAGER_HERO_TOOLSMITH_GIFT;
    public static final List<String> VILLAGER_HERO_WEAPONSMITH_GIFT;
