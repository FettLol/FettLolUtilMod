        ...
        if (FettlolModIntegrations.isRingOfAttractionLoaded) {
            ...
            LootTableLoadingCallback.EVENT.register((resourceManager, lootManager, identifier, supplier, setter) -> {
                ...
                if (LootTableHelper.isEndEndgameChest(identifier)) {
                    LootApi.addToLootTable(supplier, 1, 0.05F, FettlolModIntegrations.RING_OF_ATTRACTION, "ring_of_attraction");
                }

                if (LootTableHelper.isAbandonedMineshaftChest(identifier)) {
                    LootApi.addToLootTable(supplier, 1, 0.01F, FettlolModIntegrations.RING_OF_ATTRACTION, "ring_of_attraction");
                }
