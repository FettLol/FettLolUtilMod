        ...
        if (FettlolModIntegrations.isDankStorageLoaded) {
            ...
            LootTableLoadingCallback.EVENT.register((resourceManager, lootManager, identifier, supplier, setter) -> {
                if (LootTableHelper.isEnderDragon(identifier)) {
                    LootApi.addToLootTable(supplier, 1, 0.1F, FettlolModIntegrations.DANKSTORAGE, "dank_5");
                }

                if (LootTableHelper.isNetherEndgameChest(identifier)) {
                    LootApi.addToLootTable(supplier, 1, 0.05F, FettlolModIntegrations.DANKSTORAGE, "dank_3");
                }

                if (LootTableHelper.isEndEndgameChest(identifier)) {
                    LootApi.addToLootTable(supplier, 1, 0.05F, FettlolModIntegrations.DANKSTORAGE, "dank_4");
                }
